        ...
        <section className="bg-white py-16 px-4 sm:px-6 lg:px-20 mt-2 mb-6">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="slide-in-slow border border-gray-200 rounded-md p-6 text-left">
              ...
              <h3 className="text-lg font-semibold mb-2">Drywall Installation</h3>
            ...
            <div className="slide-in-medium border border-gray-200 rounded-md p-6 text-left">
              ...
              <h3 className="text-lg font-semibold mb-2">Drywall Repair</h3>
            ...
            <div className="slide-in-fast border border-gray-200 rounded-md p-6 text-left">
              ...
              <h3 className="text-lg font-semibold mb-2">Taping & Coating</h3>
            ...
            <div className="slide-in-medium border border-gray-200 rounded-md p-6 text-left">
              ...
              <h3 className="text-lg font-semibold mb-2">Water Damage Repair</h3>
            ...
            <div className="slide-in-fast border border-gray-200 rounded-md p-6 text-left">
              ...
              <h3 className="text-lg font-semibold mb-2">Drywall Dust Cleaning</h3>
              <p className="text-gray-600 text-sm">Thorough post-project clean-up that removes all drywall dust and debris from the work area, ensuring a spotless, safe, and ready-to-use environment once your installation or repair is complete.</p>
            </div>
          </div>
