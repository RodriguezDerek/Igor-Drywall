            ...
            <div className="p-4 border-t border-[#333333] flex items-center justify-between bg-[#161616]">
                { userData && (
                    <div className="flex items-center justify-center">
                        <button onClick={() => setIsProfileModalOpen(prev => !prev)} className="main-font font-semibold w-9.5 h-9.5 bg-[#C8102E] text-white rounded-full cursor-pointer mt-2">{userData.firstName.charAt(0).toUpperCase()}</button>
                        <div className="ml-3">
