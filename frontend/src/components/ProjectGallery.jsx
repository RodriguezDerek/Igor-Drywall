  ...
  return (
    <div className="fixed inset-0 z-50 bg-white/30 backdrop-blur-lg flex justify-center items-center px-4">
      <div className="animate-fadeIn bg-white max-w-3xl w-full rounded-xl shadow-xl p-4 relative overflow-y-auto max-h-[90vh]">
        {/* Close Button */}
        <button onClick={onClose} className="duration-300 cursor-pointer m-3 absolute top-4 right-4 text-gray-800 text-2xl bg-white rounded-full w-9 h-9 flex items-center justify-center shadow hover:scale-110 transition-transform">
          &times;
        </button>
