...
function ProfileModal({ close }) {
    ...
    return(
        <div className="bg-white shadow-lg rounded-2xl p-2 w-160 h-76 border border-gray-200 mt-2 animate-fadeIn flex flex-row">
            {/* Left column - 40% */}
            <div className="basis-[40%] h-full bg-white border-r border-gray-200 p-6 flex flex-col justify-between">
                {/* Top Section */}
                <div>
                    {/* Avatar + Info */}
                    ...
                    <div className="space-y-1 pl-2">
                        ...
                        <div className="flex text-gray-900 py-1.5 rounded-lg cursor-pointer">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm font-medium pl-1">My Profile</span>
                            </div>
                        </div>
                        ...
                        <div className="flex text-gray-900 py-1.5 rounded-lg cursor-pointer">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm font-medium pl-1">Account Settings</span>
                            </div>
                        </div>
                        ...
                        <div className="flex text-gray-900 py-1.5 rounded-lg cursor-pointer">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm font-medium pl-1">Dashboard</span>
                            </div>
                        </div>
                ...
                <div className="flex items-center space-x-2 text-gray-900 cursor-pointer hover:text-red-500 pl-2">
                    ...
                    <span className="text-sm font-medium pl-1">Log out</span>
                </div>
            </div>


            {/* Right column - 60% */}
            <div className="basis-[65%] bg-blue-500 h-full">
                {/* Navbar Options */}
            </div>
        </div>
    );
