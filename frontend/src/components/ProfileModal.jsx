            ...
            <div className="basis-[40%] h-full bg-white border-r-3 border-gray-200 p-6 flex flex-col justify-between rounded-l-2xl">
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-4 mb-6 pr-4">
                        ...
                        <div>
                            <h4 className="text-[13px] plus-jakarta-700">
                                {userData ? `${userData.lastName}, ${userData.firstName}` : 'Loading...'}
                            </h4>

                            <p className="text-[12px] plus-jakarta-500 text-gray-500">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="flex text-gray-900 py-1.5 rounded-lg custom-red-hover-effect pl-2">
                            <div className="flex items-center space-x-2">
                                ...
                                <span onClick={openMyProfile} className="text-[13px] plus-jakarta-700 pl-1 cursor-pointer">My Profile</span>
                            </div>
                        </div>
                        ...
                        <div className="flex text-gray-900 py-1.5 rounded-lg custom-red-hover-effect pl-2">
                            <div className="flex items-center space-x-2">
                                ...
                                <span onClick={openAccountSettings} className="text-[13px] plus-jakarta-700 pl-1 cursor-pointer">Account Settings</span>
                            </div>
                        </div>
                        ...
                        <div className="flex text-gray-900 py-1.5 rounded-lg custom-red-hover-effect pl-2">
                            <div className="flex items-center space-x-2">
                                ...
                                <Link to="/overview" className="text-[13px] plus-jakarta-700 pl-1 cursor-pointer">Dashboard</Link>
                            </div>
                        </div>
                ...
                <button onClick={handleLogout} className="flex items-center space-x-2 custom-logout pl-2">
                    ...
                    <span className="text-[13px] plus-jakarta-700 pl-1 cursor-pointer">Log out</span>
                </button>
            </div>
