    ...
    return (
        <header className="flex items-center justify-between bg-[#161616] px-8 py-4 text-white border-b border-[#333333]">
            ...
            <div className="flex flex-col">
                <h1 className="main-font text-lg font-semibold tracking-wide">Workers</h1>
                <nav className="flex items-center gap-2 mt-1 text-xs font-normal">
                    ...
                    <span className="text-[#888888]">Workers</span>
                </nav>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">                    
                    <button type="button" className="cursor-pointer rounded bg-[#C8102E] px-4 py-2 text-xs sub-font font-semibold text-white">+ New Job</button>
                </div>
            </div>
